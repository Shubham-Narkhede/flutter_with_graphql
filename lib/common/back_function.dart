...
class BackFunction{
  ...
  static threeDNavigator(BuildContext context, Widget enterPage, Widget exitPage) {
    return Navigator.pushReplacement(context, Pseudo3dRouteBuilder(enterPage,exitPage));
  }
}
